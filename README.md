...
- 👨‍💻 Desarrollo aplicaciones web con JavaScript, TypeScript, Node.js y PostgreSQL.
- 📚 Profundizando en frameworks frontend y backend como React, Vue, Express y NestJS, manteniendo un enfoque fuerte en fundamentos Vanilla.
- 📱 Explorando el ecosistema mobile y el desarrollo con Swift para iOS.
- 🎯 Busco crear productos excepcionales combinando bases web sólidas con el desarrollo mobile.

### 🛠 &nbsp; Tecnologías con las que me encanta trabajar
